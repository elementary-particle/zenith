...
class TestApplyEventConsistency:
    """Verify observe_event behaves consistently across game modes(仅四麻)."""

    @pytest.mark.parametrize("game_mode,start_kyoku_fn,n_players", [("default", _start_kyoku_event_4p, 4)])
    ...
    @pytest.mark.parametrize("game_mode,start_kyoku_fn", [("default", _start_kyoku_event_4p)])
