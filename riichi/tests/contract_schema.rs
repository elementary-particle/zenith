use riichi::{
    ActionKind, EventKind, ABSENT_SENTINEL, DECISION_SCHEMA_VERSION, EVENT_SCHEMA_VERSION,
    HAND_EFFICIENCY_VERSION, RNG_PROFILE_ID, RULES_PROFILE_ID, SHANTEN_UNAVAILABLE,
    SNAPSHOT_SCHEMA_VERSION, STATE_SCHEMA_VERSION,
};
...
fn stable_numeric_contract() {
    ...
    assert_eq!(HAND_EFFICIENCY_VERSION, 1);
