...
#[cfg_attr(any(), pyclass(eq, eq_int, from_py_object))]
...
#[cfg_attr(any(), pyclass(from_py_object))]
...
#[cfg_attr(any(), pyclass(get_all, set_all, from_py_object))]
#[derive(Debug, Clone)]
...
impl WinResult {
    ...
    pub fn yaku_list(&self) -> Vec<crate::evaluator::yaku::Yaku> {
        self.yaku
            .iter()
            .filter_map(|&id| crate::evaluator::yaku::get_yaku_by_id(id))
            .collect()
    }
}
