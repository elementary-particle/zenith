...
final_dir="${experiment_dir}/results/privileged_actor_hidden_current_kyoku_qboost"
staging_dir="${experiment_dir}/results/.privileged_actor_hidden_current_kyoku_qboost-staging"
